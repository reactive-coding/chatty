...
public class ToolBarHelper {
    ...
    * */
    ...
    private void initActivityView(int id) {
         ...
         * 获取主题中定义的toolbar的高度
         */
        int toolBarSize = (int) typedArray.getDimension(1, mContext.getResources().getDimension(R.dimen.dp_80));
        typedArray.recycle();
        /**
         * 如果是悬浮状态，则不需要设置间距
         */
        ...
        params.topMargin = (int)mContext.getResources().getDimension(R.dimen.dp_80);
