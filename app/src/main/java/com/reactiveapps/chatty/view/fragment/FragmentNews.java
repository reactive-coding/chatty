 ...
 * {@link OnFragmentNewsListener} interface
...
public class FragmentNews extends FragmentBase {
    ...
    private OnFragmentNewsListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentNewsListener) {
            mListener = (OnFragmentNewsListener) context;
        } else {
     ...
     */
    public interface OnFragmentNewsListener {
