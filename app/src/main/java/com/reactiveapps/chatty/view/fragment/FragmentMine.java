 ...
 * {@link OnFragmentMineListener} interface
...
public class FragmentMine extends FragmentBase {
    ...
    private OnFragmentMineListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentMineListener) {
            mListener = (OnFragmentMineListener) context;
        } else {
     ...
     */
    public interface OnFragmentMineListener {
