 ...
 * {@link OnFragmentContactsListener} interface
...
public class FragmentContacts extends FragmentBase {
    ...
    private OnFragmentContactsListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentContactsListener) {
            mListener = (OnFragmentContactsListener) context;
        } else {
     ...
     */
    public interface OnFragmentContactsListener {
