...
public class BundleArguments {
    ...
    public final static String TYPE_KEY_AD_FRAGMENT = "PersonalPostFragment_type_key";
    public final static String BIG_GALLERY_PHOTO_SELECT = "selected_index";
    public final static String BIG_GALLERY_URIS = "uris";

    public final static String GUIDE_RES = "res";

    public static final String RESULT = "result";

    public final static String ARG_IS_MY_RESUME = "isMyResume";
    public final static String ARG_RESUME = "resume";
    public final static String ARG_RESUME_ID = "resume_id";
